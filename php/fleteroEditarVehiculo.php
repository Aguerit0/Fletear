...
if (isset($_POST['submit'])) {
  $contador = 0;
  if (!empty($_FILES)) {
    if (isset($_FILES['vehiculoVehiculo']) or isset($_FILES['tituloVehiculo']) or isset($_FILES['seguroVehiculo']) or isset($_POST['tipoVehiculo']) or isset($_POST['colorVehiculo']) or isset($_POST['descripcionVehiculo'])) {
      //IMAGEN VEHÍCULO
      ...
      if ($res1) {
        ...
        $sql2 = "UPDATE vehiculo SET vehiculoVehiculo='$rutaVehiculo', seguroVehiculo='$rutaSeguro', tituloVehiculo='$rutaTitulo', tipoVehiculo='$tipoVehiculo', colorVehiculo='$colorVehiculo', descripcionVehiculo='$descripcionVehiculo' WHERE idVehiculo='$idVehiculo' ";
            ...
            <form class="row g-3 needs-validation" method="POST" enctype="multipart/form-data" novalidate>
              ...
              <div class="col-4">
                ...
                <div class="vehiculo-img">
                  <img src="<?php echo $vehiculoVehiculo ?>" alt="vehiculoVehiculoPrev" id="vehiculoVehiculoPrev" />
              ...
              <div class="col-4">
                ...
                <div class="vehiculo-img">
                  <img src="<?php echo $seguroVehiculo ?>" alt="seguroVehiculoPrev" id="seguroVehiculoPrev" />
                  <div class="file btn btn-lg btn-primary">
                    Subir Imagen
              ...
              <div class="col-4">
                ...
                <div class="vehiculo-img">
                  <img src="<?php echo $tituloVehiculo ?>" alt="tituloVehiculoPrev" id="tituloVehiculoPrev" />
                  <div class="file btn btn-lg btn-primary">
                    Subir Imagen
              ...
              <div class="col-4">
                ...
                <select disabled require name="tipoVehiculo" id="tipoVehiculo" class="form-select">
                <?php
                  if ($tipoVehiculo == 0) {
              ...
              <div class="col-4">
                ...
                <div class="input-group has-validation">
                  <input require type="text" class="form-control" name="descripcionVehiculo" id="descripcionVehiculo" value="<?php echo $descripcionVehiculo ?>">
              ...
              <div class="col-12 d-flex align-items-center justify-content-center">
                <button class="btn btn-primary w-50" type="submit" name="submit">Guardar</button>
              </div>
            </form>
          </div>
        </div>
